---
name: handoff
description: Write a session-end handoff note to docs/handoffs/YYYY-MM-DD-HHMM.md. Run at the end of every Codex session so future Ludvig (after weeks away) can pick up.
allowed-tools:
  - Read
  - Write
  - Bash(git status:*)
...
- **Codex model:** <model name if known>
...
- <Anything Codex needs clarified before continuing>
