...
3. **For each changed file, apply the relevant rules.** Read these in order:
   - `.Codex/rules/backend.md` — Hono, validation, errors, logging, structure
   - `.Codex/rules/database.md` — RLS, indexes, migrations, queries
   - `.Codex/rules/security.md` — auth, JWT, PII, GDPR
