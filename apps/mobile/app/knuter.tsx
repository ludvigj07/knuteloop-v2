...
export default function KnuterScreen() {
  ...
  if (isLoading) return <KnuteCatalogLoading />
  ...
  if (error && !data)
    return <KnuteCatalogError message={(error as Error).message} onRetry={() => void refetch()} />
  ...
  const listHeader = (
    <View style={styles.headerWrap}>
      <View style={styles.hero}>
        ...
        >
          Hva tar du{' '}
          <Text font="display" weight="bold" style={[styles.heading, styles.headingHighlight]}>
            i dag?
          </Text>
        </Text>
