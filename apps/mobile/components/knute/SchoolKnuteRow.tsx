...
// are separate sibling pressables (no nested-pressable tap conflicts).
...
export function SchoolKnuteRow({
  ...
  return (
    <StickerCard radius="md" shadow="sm" padding="md" style={[styles.card, inactive ? styles.dim : null]}>
